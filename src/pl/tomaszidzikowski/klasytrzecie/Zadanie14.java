...
/*
* Napisz program, który doda 100 000 elementów do ArrayList
* i sprawdzi wydajność wyświetlania jej elementów przy użyciu różnych pętli
   for (int i=0,...), foreach, Iterator
 */
